...
class Location {
  ...
  // method that fetches locations
  static List<Location> fetchAll() {
    return [
      Location(
          id: 1,
          name: 'Kiyomizu-dera',
          imagePath: 'assets/images/kiyomizu-dera.jpeg',
      ...
      Location(
          id: 2,
          name: 'Mount Fuji',
          imagePath: 'assets/images/fuji.jpeg',
      ...
      Location(
          ...
          imagePath: 'assets/images/bamboo.jpg',
  ...
  static Location fetchByID(int locationId) {
    // fetch all locations, iterate them and when we find location with required id return it immediately
